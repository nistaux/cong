...
:: Source c files
set SrcFiles=.\src\main.c .\src\game.c .\src\window.c .\src\events.c .\src\render.c .\src\debug.c .\src\rand.c .\src\controls.c .\src\animation.c .\src\ui.c .\src\res\cong.res
