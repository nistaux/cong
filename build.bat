...
:: Source c files
set SrcFiles=.\src\main.c .\src\game.c .\src\window.c .\src\events.c .\src\render.c .\src\pong.c .\src\debug.c .\src\rand.c .\src\puck.c .\src\controls.c .\src\animation.c .\src\res\cong.res
